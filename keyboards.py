...
SETTING_LABELS = {
    ...
    "kpi_late_light_max":        "макс лёгких опозданий до штрафа (напр. 4)",
    "kpi_late_medium_max":       "макс средних опозданий до штрафа (напр. 3)",
    "kpi_late_heavy_max":        "макс серьёзных опозданий до штрафа (напр. 2)",
